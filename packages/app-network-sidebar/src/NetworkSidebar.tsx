...
export default function NetworkSidebar(): JSX.Element {
  ...
  return (
    <div className='bg-transparent'>
      ...
      <div className='hidden md:inline-flex md:flex-col bg-transparent dark:bg-[#0A0A0B]  md:h-full mr-5'>
        <p className='ml-1 hidden md:block text-gray-800 dark:text-white text-md font-semibold font-kanit '>
          NETWORK
        </p>
        {/* wideScreen network */}
        <NetworkSelection />
