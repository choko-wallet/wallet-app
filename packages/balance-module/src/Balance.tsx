...
function Balance({ balance }: Props): JSX.Element {
  ...
  return (
    <div className='relative flex flex-col bg-white dark:bg-[#1A1A1A] w-full rounded-[8px] font-poppins py-5 px-3 my-3 md:my-0 lg:px-6 lg:py-8'>
      ...
      <div className='flex items-center justify-between mt-5 md:mt-10 md:h-16 px-5 z-20'>
        <div className='flex items-center justify-start xl:w-32'>
          <p className='hidden sm:inline-flex text-black text-xs font-poppins dark:text-gray-400'>
            Your Portfolio
          </p>
          {/* searchInputOpen
            ? null
        ...
        <p className='hidden sm:inline-flex text-black dark:text-gray-400 justify-end xl:w-32 '>
          Total Balance
        </p>
      </div>
      ...
      <div className='flex flex-col scrollbar-thin min-h-[400px] h-full overflow-y-scroll z-20'>
        {searchInputOpen ? (
          ...
          <div className='flex lg:hidden py-2 w-full items-center rounded-[10px] '></div>
        )}
