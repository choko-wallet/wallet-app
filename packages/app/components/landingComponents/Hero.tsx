        ...
        >
          ...
          <motion.div variants={fadeIn('up', 'spring', 0.8, 1)}>
            <p className='text-[10px] sm:text-[15px] md:text-[15px] xl:text-[20px] w-full lg:px-0 lg:mt-10 mt-5 pb-2 lg:mx-0 max-w-[300px] md:max-w-[400px] lg:max-w-[450px] xl:max-w-[600px] mx-auto font-inter  text-[#FFFFFE] text-start '>
              Trade, own, social and immerse in web 3.0 on your preferred
              blockchain with secured gas-less transaction and account
              abstraction support.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className='space-y-2 lg:mt-16  w-full lg:w-fit '>
              ...
              <div className='flex justify-between mx-auto w-full lg:w-[360px] space-x-2 '>
                <button
                  className=' text-[10px] lg:text-xl text-[#0170BF] font-semibold transition duration-150 rounded-md hover:shadow-sm active:scale-90 h-10 lg:h-[50px] w-[136px] md:w-48 bg-white font-inter'
