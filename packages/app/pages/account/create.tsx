    ...
    <main className='bg-[#383A53] min-h-screen px-3 md:px-6'>
      <div className='max-w-2xl min-h-screen mx-auto w-full flex flex-col items-center justify-center overflow-hidden md:overflow-visible'>
        ...
        <div className='hidden md:flex w-full space-x-1'>
          <label className='checkContainer2 font-poppins'>
            <input
          ...
          <ProgressBar
            ...
            completed={step === 1 ? 0 : step === 2 ? 100 : 100}
            customLabel=' '
            height='3px'
          />
        ...
        <div className='hidden md:flex w-full max-w-2xl justify-center mt-5 h-5 relative  '>
          ...
          <p
            className={`absolute top-0 -right-6 text-xs md:text-sm font-poppins ${
              step > 2 &&
              password &&
              repeatPassword &&
              password === repeatPassword
              ...
              <div className='w-full max-w-2xl  '>
                <div className='mt-8 md:mt-16 bg-white h-[480px] md:h-96 rounded-[10px] flex flex-col justify-center w-full max-w-3xl px-[30px] md:p-12 '>
                  ...
                  <div className='flex items-center justify-between max-w-[276px] relative mt-3'>
                    <button
                      className='flex items-center w-[120px] h-[33px] ml-1  my-[16px] justify-center group  font-bold  transition duration-150
                bg-[#FDF7DE] rounded-md hover:shadow-sm active:scale-95 '
                    ...
                    >
                      ...
                      <p className='text-[#0170BF] text-sm font-poppins'>
                        REFRESH
                      </p>
                    </button>
                    ...
                    >
                      <button
                        className='flex items-center justify-center  w-[120px] h-[33px] mr-1  my-[16px]   font-bold  transition duration-150
                bg-[#0170BF] rounded-md hover:shadow-sm active:scale-95 '
                      >
                        ...
                        <p className='text-[#F5CBD5] text-sm font-poppins'>
                          COPY
                        </p>
                      </button>
                    </CopyToClipboard>
                    ...
                    {copied ? (
                      <p className='text-[#99D8FF] font-poppins h-6 absolute top-[55px] left-[200px]'>
                        COPIED!
                      </p>
                    ) : (
                ...
                <div className='flex justify-evenly mt-12 md:mt-20'>
                  ...
                  <button
                    className='bg-[#0170BF] rounded-full p-2'
              ...
              <div className='w-full max-w-2xl '>
                <div className='mt-8 md:mt-16 bg-white h-[480px] md:h-96 rounded-[10px] flex flex-col space-y-5  w-full max-w-3xl md:p-12 pt-5 relative'>
                  ...
                  <p className='w-[300px] md:w-full mx-auto text-center text-black text-sm md:text-xl md:-mt-5 font-poppins'>
                    Ensure that you keep the secret seed in a safe place.
                  </p>
                  ...
                  <div className='flex items-center justify-center p-10'>
                    ...
                    <input
                      className='w-[160px] h-12 pl-3 border border-[#94C5E3] rounded-md bg-gray-50 sm:text-sm focus:ring-none outline-none'
                  ...
                  <div className='absolute bottom-8 left-5 md:left-10 text-[#C67391] flex flex-col  justify-center items-start '>
                    ...
                    <label className='checkContainer font-poppins pt-[2px]'>
                      If I lose my seed, I will lose my fund
                      <input
                        checked={check2}
                ...
                <div className='flex justify-evenly mt-12 md:mt-20'>
                  <button
                    className='bg-[#F5CBD5] rounded-full p-2 flex items-center justify-center'
                    onClick={() => setStep(1)}
                  >
              ...
              <div className='w-full max-w-2xl '>
                ...
                <div className='mt-8 md:mt-16 bg-white h-[480px] md:h-96 rounded-[10px] flex flex-col space-y-5  w-full max-w-3xl p-5 md:p-12'>
                  ...
                  <div className='flex items-center justify-between px-10 '>
                    ...
                    <input
                      className='w-[150px] md:w-[200px] h-12 ml-3 pl-3 border border-[#94C5E3] rounded-md bg-gray-50 sm:text-sm focus:ring-none outline-none'
