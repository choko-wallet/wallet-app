...
function SuperButton({ Icon, title, onClick, rotate }: Props) {
  return (
    <div className="flex flex-col justify-center items-center w-[140px] h-[76px] bg-gray-400 dark:bg-[#384855] hover:bg-[#4797B5]  rounded-2xl   cursor-pointer space-y-1">
