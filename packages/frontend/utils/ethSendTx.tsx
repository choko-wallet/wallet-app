...
// Entry point
export const ethDecodeTxAndRedirect = async (network: Network, cryptoToSend: CryptoBalance, amount: number, addressToSend: string, balanceInfo: BalanceInfo): Promise<void> => {
