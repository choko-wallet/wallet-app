...
function Header(): JSX.Element {
  ...
  if (!mounted) {
    // 其他组件可以不需要setMounted 和 没有mouted retur nnull
    return null;
  }
    ...
    <div className='sticky top-0 z-20 backdrop-blur-lg border-none md:border-b border-[#C5CEDE]'>
      <div className='flex justify-between p-3 '>
        ...
        <div className='flex items-center text-gray-500 '>
          ...
          <MenuAlt4Icon
            className='transition duration-150 ease-out cursor-pointer md:hidden active:scale-125 h-[22px] m-2 text-black dark:text-gray-500'
