...
export default function AccountInHeader (): JSX.Element {
  ...
  return (
    <div className=' xl:w-64 text-right md:w-12 '>
      ...
      >
        <motion.button
          className='flex items-center justify-center rounded-md w-full xl:bg-white dark:bg-transparent md:bg-transparent md:px-4 md:py-2 h-full text-sm font-medium text-black focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75'
        ...
        >
          ...
          <motion.li className='z-50'
            ...
            >
              ...
              <p className='font-poppins text-black dark:text-white text-start w-32 px-3'>
                Settings
              </p>
            </button>
          </motion.li>
          ...
          {/* <motion.li className='z-50' variants={itemVariants}>
            ...
            >
              <div className='mx-3'>
                {theme === "light" ? (
                  <SunIcon
                    className='h-7 transition text-gray-800 duration-150 ease-out cursor-pointer md:inline-flex active:scale-125 '
                    onClick={() => setTheme("dark")}
                  />
                ) : (
                  <MoonIcon
                    className='h-7 transition duration-150 ease-out cursor-pointer md:inline-flex active:scale-125 dark:text-white'
                    onClick={() => setTheme("light")}
                  />
                )}
              </div>
              <p className='font-poppins text-black dark:text-white text-center w-32 '>
                Swich Mode
              </p>
            </button>
          </motion.li> */}
